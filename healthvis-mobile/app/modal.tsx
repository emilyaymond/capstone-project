...
export default function ModalScreen() {
  const { mode, setMode, settings, updateSettings, isLoading, error } =
    useAccessibility();
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <ThemedText style={styles.helperText}>
            Select your preferred accessibility mode. Each mode provides
            different features and interface adaptations.
          </ThemedText>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity
              style={[
                styles.button,
                settings.fontSize === "small" && styles.activeButton,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.button,
                settings.fontSize === "medium" && styles.activeButton,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.button,
                settings.fontSize === "large" && styles.activeButton,
              ]}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity
              style={[
                styles.button,
                settings.contrast === "normal" && styles.activeButton,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.button,
                settings.contrast === "high" && styles.activeButton,
              ]}
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            style={[
              styles.toggleButton,
              settings.audioEnabled && styles.activeButton,
            ]}
            onPress={() =>
          ...
          <TouchableOpacity
            style={[
              styles.toggleButton,
              settings.hapticsEnabled && styles.activeButton,
            ]}
            onPress={() =>
        ...
        <View style={styles.section}>
          ...
          <ThemedText style={styles.helperText}>
            Enable VoiceOver (iOS) or TalkBack (Android) to hear these
            announcements
          </ThemedText>
          <View style={styles.buttonRow}>
            <TouchableOpacity
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={() =>
                announce("This is an assertive announcement", {
                  priority: "assertive",
                })
              }
            >
        ...
        <View style={styles.section}>
          ...
          <ThemedText style={styles.helperText}>
            These buttons use the new AccessibleButton component with automatic
          ...
          <ThemedText style={styles.helperText}>
            Notice: In simplified mode, buttons are larger (56x56 minimum).
            Audio feedback plays in audio/hybrid modes. Haptics trigger when
            enabled.
          </ThemedText>
        </View>
